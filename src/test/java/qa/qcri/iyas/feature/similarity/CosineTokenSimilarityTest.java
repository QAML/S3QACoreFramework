...
/**
 * A simple class to test class {@link CosineTokenSimilarity}.
 * 
 * @author Giovanni Da San Martino
 *
 */
public class CosineTokenSimilarityTest {
	...
	public void testGetSimilarityValue() throws IOException, URISyntaxException, UIMAException {
		AnalysisEngineDescription descr = AnalysisEngineFactory.createEngineDescriptionFromPath(
				new File(CosineTokenSimilarityTest.class.getResource(
		...
		ExternalResourceFactory.bindResource(similarityTestAnnotatorAE_Descriptor,
				SimilarityMeasureTestAnnotator.PARAM_SIMILARITY_RESOURCE, CosineTokenSimilarity.class,"",
				ExternalResourceFactory.PARAM_RESOURCE_NAME,"cosineTokenSimilarity",
				CosineTokenSimilarity.PARAM_NAME_STOPWORDS_OBJECT, Stopwords.STOPWORD_EN,
				CosineTokenSimilarity.PARAM_NAME_REMOVE_STOPWORDS, true);
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(CosineTokenSimilarityTest.class);
