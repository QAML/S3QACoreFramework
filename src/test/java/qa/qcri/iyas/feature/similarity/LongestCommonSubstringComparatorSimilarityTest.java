...
/**
 * A simple class to test class {@link LongestCommonSubstringComparatorSimilarity}.
 * 
 * @author Giovanni Da San Martino
 *
 */
public class LongestCommonSubstringComparatorSimilarityTest {
	...
	public void testGetSimilarityValue() throws IOException, URISyntaxException, UIMAException {
		AnalysisEngineDescription descr = AnalysisEngineFactory.createEngineDescriptionFromPath(
				new File(LongestCommonSubstringComparatorSimilarityTest.class.getResource(
		...
		ExternalResourceFactory.bindResource(similarityTestAnnotatorAE_Descriptor,
				SimilarityMeasureTestAnnotator.PARAM_SIMILARITY_RESOURCE, LongestCommonSubstringComparatorSimilarity.class,"",
				ExternalResourceFactory.PARAM_RESOURCE_NAME,"longestCommonSubstringComparatorSimilarity",
				LongestCommonSubstringComparatorSimilarity.PARAM_NAME_STOPWORDS_OBJECT, Stopwords.STOPWORD_EN,
				LongestCommonSubstringComparatorSimilarity.PARAM_NAME_REMOVE_STOPWORDS, true);
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(LongestCommonSubstringComparatorSimilarityTest.class);
