 ...
 * @generated */
public class InstanceC extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(InstanceC.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected InstanceC() {/* intentionally empty block */}
   ...
   */
  public InstanceC(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public InstanceC(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
