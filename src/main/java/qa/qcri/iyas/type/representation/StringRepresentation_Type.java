 ...
 * @generated */
public class StringRepresentation_Type extends Representation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = StringRepresentation.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("qa.qcri.iyas.type.representation.StringRepresentation");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "qa.qcri.iyas.type.representation.StringRepresentation");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public StringRepresentation_Type(JCas jcas, Type casType) {
    super(jcas, casType);
